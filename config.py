...
class PrismalWaveConfig:
    ...
    mot_routing_temperature: float = 0.35
    ...
    torus_activity_threshold: float = 0.12
    torus_active_target_fraction: float = 0.75
    torus_active_balance_weight: float = 0.55
    ...
    emitter_balance_weight: float = 1.05
    emitter_mixture_target_count: float = 12
    ...
    contrastive_routing_weight: float = 0.35
    ...
    routing_entropy_weight: float = 0.35
