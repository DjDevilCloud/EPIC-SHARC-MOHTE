...
class PrismalWaveConfig:
    ...
    hierarchical_precision_accumulator_dtype: str = "fp8"
    ...
    factorized_embedding_dim: int = 512
    ...
    hierarchical_byte_tier: bool = False
    hierarchical_d_model_scale: float = 0.5
    hierarchical_min_d_model: int = 128
    ...
    signature_lattice_chunk_len: int = 24
    ...
    learned_residency_weight: float = 0.2
    ...
    recursive_hidden_mix_scale: float = 0.25
    ...
    emitter_balance_weight: float = 0.8
    emitter_mixture_target_count: float = 1024
    emitter_mixture_weight: float = 0.25
    ...
    signature_temperature: float = 0.25
    ...
    signature_contrastive_weight: float = 0.05
